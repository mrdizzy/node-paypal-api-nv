...
vows.describe("Import PayPal Transactions").addBatch({
    ...
    "A request for an invalid method": {
        topic: function() {
            nock('https://api-3t.paypal.com').post('/nvp', "METHOD=Getoalance&VERSION=86.0&USER=david.p_api1.casamiento-cards.co.uk&PWD=WZFA2LEYHLMVS8GC&SIGNATURE=AFcWxV21C7fd0v3bYYYRCpSSRl31AGarkFSt5jUYyxNcPfou1CUmwV3u").reply(200, "ACK=Failure&L_ERRORCODE0=81002&L_SHORTMESSAGE0=Unspecified%20Method&L_LONGMESSAGE0=Method%20Specified%20is%20not%20Supported&L_SEVERITYCODE0=Error", {
